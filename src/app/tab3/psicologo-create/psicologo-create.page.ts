...
@Component({
  selector: 'app-psicologo-create',
  templateUrl: './psicologo-create.page.html',
  styleUrls: ['./psicologo-create.page.scss'],
})
export class PsicologoCreatePage implements OnInit {
